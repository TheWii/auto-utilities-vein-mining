...
tag @e[type=item,limit=1,sort=nearest,distance=..8,nbt={Age:0s,Item:{tag:{OreDict:["oreTin"]}}}] add tw.vm.ore
tag @e[type=item,limit=1,sort=nearest,distance=..8,nbt={Age:0s,Item:{tag:{OreDict:["ingotTin"]}}}] add tw.vm.ore
