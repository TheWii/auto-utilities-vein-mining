...
tag @e[type=item,limit=1,sort=nearest,distance=..8,nbt={Age:0s,Item:{tag:{OreDict:["oreCopper"]}}}] add tw.vm.ore
tag @e[type=item,limit=1,sort=nearest,distance=..8,nbt={Age:0s,Item:{tag:{OreDict:["ingotCopper"]}}}] add tw.vm.ore
