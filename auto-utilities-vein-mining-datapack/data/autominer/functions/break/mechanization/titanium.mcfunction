...
tag @e[type=item,limit=1,sort=nearest,distance=..8,nbt={Age:0s,Item:{tag:{OreDict:["oreTitanium"]}}}] add tw.vm.ore
tag @e[type=item,limit=1,sort=nearest,distance=..8,nbt={Age:0s,Item:{tag:{OreDict:["ingotTitanium"]}}}] add tw.vm.ore
