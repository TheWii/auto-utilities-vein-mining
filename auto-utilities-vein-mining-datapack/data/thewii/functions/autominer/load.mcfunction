...
# Success
execute if score #valid_load twvm.tool matches 1 unless data storage thewii:autominer/data {installed:0b} run scoreboard players set $installed twvm.tool 1
execute if score #valid_load twvm.tool matches 1 unless data storage thewii:autominer/data {installed:0b} run function thewii:autominer/load_2
