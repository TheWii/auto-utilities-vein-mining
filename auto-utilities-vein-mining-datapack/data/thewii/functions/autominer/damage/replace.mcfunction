...
execute in minecraft:overworld run data modify block 29999983 0 4320 Items[0] set from entity @s SelectedItem
execute in minecraft:overworld store result block 29999983 0 4320 Items[0].tag.Damage int 1 run scoreboard players get $damaged twvm.tool
