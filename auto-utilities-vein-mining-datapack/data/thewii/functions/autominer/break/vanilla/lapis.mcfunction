...
tag @e[type=item,limit=1,sort=nearest,distance=..8,tag=!global.ignore,nbt={Age:0s,Item:{id:"minecraft:lapis_ore"}}] add twvm.ore
tag @e[type=item,limit=1,sort=nearest,distance=..8,tag=!global.ignore,nbt={Age:0s,Item:{id:"minecraft:lapis_lazuli"}}] add twvm.ore
