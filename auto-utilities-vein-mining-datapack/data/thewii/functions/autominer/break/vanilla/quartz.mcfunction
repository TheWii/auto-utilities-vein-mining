...
tag @e[type=item,limit=1,sort=nearest,distance=..8,tag=!global.ignore,nbt={Age:0s,Item:{id:"minecraft:nether_quartz_ore"}}] add twvm.ore
tag @e[type=item,limit=1,sort=nearest,distance=..8,tag=!global.ignore,nbt={Age:0s,Item:{id:"minecraft:quartz"}}] add twvm.ore
